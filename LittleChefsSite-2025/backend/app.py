...
def send_order_notification(order_id, customer_name, items, total_amount):
    ...
    msg = EmailMessage()
    msg['Subject'] = subject
    msg['From'] = "lumerskywalker@gmail.com"  # <-- Replace with your Gmail
    msg['To'] = "lumerskywalker@gmail.com"
    msg.set_content(body)

    # Send email using Gmail SMTP
    try:
        with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
            smtp.login("lumerskywalker@gmail.com", "xakdphmtmwwdrzhx")  # <-- Replace with your Gmail and App Password
